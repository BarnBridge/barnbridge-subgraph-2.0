...
export class crDAIRewardsPool extends ethereum.SmartContract {
  static bind(address: Address): crDAIRewardsPool {
    return new crDAIRewardsPool("crDAIRewardsPool", address);
  }
