...
export class SmartExposure_WETH_USDC__getTrancheResultValue0Struct extends ethereum.Tuple {
  get eToken(): Address {
...
export class SmartExposure_WETH_USDC__getTranchesResult_tranchesStruct extends ethereum.Tuple {
  get eToken(): Address {
    return this[0].toAddress();
  }
...
export class SmartExposure_WETH_USDC__issueExactResult {
  value0: BigInt;
  value1: BigInt;
...
export class SmartExposure_WETH_USDC__rebalanceResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SmartExposure_WETH_USDC__redeemExactResult {
  value0: BigInt;
  value1: BigInt;
...
export class SmartExposure_WETH_USDC__tranchesResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SmartExposure_WETH_USDC extends ethereum.SmartContract {
  static bind(address: Address): SmartExposure_WETH_USDC {
    return new SmartExposure_WETH_USDC("SmartExposure_WETH_USDC", address);
  }
  ...
  getTranche(
    eToken: Address
  ): SmartExposure_WETH_USDC__getTrancheResultValue0Struct {
    let result = super.call(
      "getTranche",
    ...
    return result[0].toTuple() as SmartExposure_WETH_USDC__getTrancheResultValue0Struct;
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as SmartExposure_WETH_USDC__getTrancheResultValue0Struct
    );
  }

  getTranches(): Array<
    SmartExposure_WETH_USDC__getTranchesResult_tranchesStruct
  > {
    let result = super.call(
      "getTranches",
  ...
  try_getTranches(): ethereum.CallResult<
    Array<SmartExposure_WETH_USDC__getTranchesResult_tranchesStruct>
  > {
    let result = super.tryCall(
      "getTranches",
      "getTranches():((address,uint256,uint256,uint256,uint256)[])",
  ...
  issueExact(
    eToken: Address,
    amount: BigInt
  ): SmartExposure_WETH_USDC__issueExactResult {
    let result = super.call(
      "issueExact",
    ...
    return new SmartExposure_WETH_USDC__issueExactResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_issueExact(
    eToken: Address,
    amount: BigInt
  ): ethereum.CallResult<SmartExposure_WETH_USDC__issueExactResult> {
    let result = super.tryCall(
      "issueExact",
      "issueExact(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SmartExposure_WETH_USDC__issueExactResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  rebalance(fracDelta: BigInt): SmartExposure_WETH_USDC__rebalanceResult {
    let result = super.call(
      "rebalance",
    ...
    return new SmartExposure_WETH_USDC__rebalanceResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_rebalance(
    fracDelta: BigInt
  ): ethereum.CallResult<SmartExposure_WETH_USDC__rebalanceResult> {
    let result = super.tryCall(
      "rebalance",
      "rebalance(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(fracDelta)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SmartExposure_WETH_USDC__rebalanceResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  redeemExact(
    eToken: Address,
    amount: BigInt
  ): SmartExposure_WETH_USDC__redeemExactResult {
    let result = super.call(
      "redeemExact",
    ...
    return new SmartExposure_WETH_USDC__redeemExactResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_redeemExact(
    eToken: Address,
    amount: BigInt
  ): ethereum.CallResult<SmartExposure_WETH_USDC__redeemExactResult> {
    let result = super.tryCall(
      "redeemExact",
      "redeemExact(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SmartExposure_WETH_USDC__redeemExactResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tranches(param0: Address): SmartExposure_WETH_USDC__tranchesResult {
    let result = super.call(
      "tranches",
    ...
    return new SmartExposure_WETH_USDC__tranchesResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_tranches(
    param0: Address
  ): ethereum.CallResult<SmartExposure_WETH_USDC__tranchesResult> {
    let result = super.tryCall(
      "tranches",
      "tranches(address):(address,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SmartExposure_WETH_USDC__tranchesResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
