...
export class bb_aRAI__abondResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class bb_aRAI__juniorBondsResult {
  value0: BigInt;
  value1: BigInt;
...
export class bb_aRAI__juniorBondsMaturingAtResult {
  value0: BigInt;
  value1: BigInt;
...
export class bb_aRAI__seniorBondsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class bb_aRAI extends ethereum.SmartContract {
  static bind(address: Address): bb_aRAI {
    return new bb_aRAI("bb_aRAI", address);
  }
  ...
  abond(): bb_aRAI__abondResult {
    ...
    return new bb_aRAI__abondResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_abond(): ethereum.CallResult<bb_aRAI__abondResult> {
  ...
  juniorBonds(param0: BigInt): bb_aRAI__juniorBondsResult {
    let result = super.call(
      "juniorBonds",
    ...
    return new bb_aRAI__juniorBondsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_juniorBonds(
    param0: BigInt
  ): ethereum.CallResult<bb_aRAI__juniorBondsResult> {
    let result = super.tryCall(
      "juniorBonds",
      "juniorBonds(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new bb_aRAI__juniorBondsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  juniorBondsMaturingAt(param0: BigInt): bb_aRAI__juniorBondsMaturingAtResult {
    let result = super.call(
    ...
    return new bb_aRAI__juniorBondsMaturingAtResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_juniorBondsMaturingAt(
    param0: BigInt
  ): ethereum.CallResult<bb_aRAI__juniorBondsMaturingAtResult> {
    let result = super.tryCall(
      "juniorBondsMaturingAt",
      "juniorBondsMaturingAt(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new bb_aRAI__juniorBondsMaturingAtResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  seniorBonds(param0: BigInt): bb_aRAI__seniorBondsResult {
    let result = super.call(
      "seniorBonds",
    ...
    return new bb_aRAI__seniorBondsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_seniorBonds(
    param0: BigInt
  ): ethereum.CallResult<bb_aRAI__seniorBondsResult> {
    let result = super.tryCall(
      "seniorBonds",
      "seniorBonds(uint256):(uint256,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new bb_aRAI__seniorBondsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
