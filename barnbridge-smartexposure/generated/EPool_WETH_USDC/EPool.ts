...
export class EPool__getTrancheResultValue0Struct extends ethereum.Tuple {
  get eToken(): Address {
...
export class EPool__getTranchesResult_tranchesStruct extends ethereum.Tuple {
  get eToken(): Address {
    return this[0].toAddress();
  }
...
export class EPool__issueExactResult {
  value0: BigInt;
  value1: BigInt;
...
export class EPool__rebalanceResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class EPool__redeemExactResult {
  value0: BigInt;
  value1: BigInt;
...
export class EPool__tranchesResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class EPool extends ethereum.SmartContract {
  static bind(address: Address): EPool {
    return new EPool("EPool", address);
  }
  ...
  getTranche(eToken: Address): EPool__getTrancheResultValue0Struct {
    let result = super.call(
      "getTranche",
    ...
    return result[0].toTuple() as EPool__getTrancheResultValue0Struct;
  }

  try_getTranche(
    eToken: Address
  ): ethereum.CallResult<EPool__getTrancheResultValue0Struct> {
    let result = super.tryCall(
      "getTranche",
      "getTranche(address):((address,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(eToken)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as EPool__getTrancheResultValue0Struct
    );
  }

  getTranches(): Array<EPool__getTranchesResult_tranchesStruct> {
    let result = super.call(
      "getTranches",
    ...
    return result[0].toTupleArray<EPool__getTranchesResult_tranchesStruct>();
  }

  try_getTranches(): ethereum.CallResult<
    Array<EPool__getTranchesResult_tranchesStruct>
  > {
    let result = super.tryCall(
      "getTranches",
      "getTranches():((address,uint256,uint256,uint256,uint256)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<EPool__getTranchesResult_tranchesStruct>()
    );
  }

  issueExact(eToken: Address, amount: BigInt): EPool__issueExactResult {
    let result = super.call(
      "issueExact",
    ...
    return new EPool__issueExactResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_issueExact(
    eToken: Address,
    amount: BigInt
  ): ethereum.CallResult<EPool__issueExactResult> {
    let result = super.tryCall(
      "issueExact",
      "issueExact(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EPool__issueExactResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  rebalance(fracDelta: BigInt): EPool__rebalanceResult {
    let result = super.call(
      "rebalance",
    ...
    return new EPool__rebalanceResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_rebalance(
    fracDelta: BigInt
  ): ethereum.CallResult<EPool__rebalanceResult> {
    let result = super.tryCall(
      "rebalance",
      "rebalance(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(fracDelta)]
  ...
  redeemExact(eToken: Address, amount: BigInt): EPool__redeemExactResult {
    let result = super.call(
      "redeemExact",
    ...
    return new EPool__redeemExactResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_redeemExact(
    eToken: Address,
    amount: BigInt
  ): ethereum.CallResult<EPool__redeemExactResult> {
    let result = super.tryCall(
      "redeemExact",
      "redeemExact(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EPool__redeemExactResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  tranches(param0: Address): EPool__tranchesResult {
    let result = super.call(
      "tranches",
    ...
    return new EPool__tranchesResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_tranches(param0: Address): ethereum.CallResult<EPool__tranchesResult> {
    let result = super.tryCall(
      "tranches",
      "tranches(address):(address,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
