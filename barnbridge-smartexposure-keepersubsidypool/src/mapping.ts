...
import {
  ...
  SetBeneficiary,
  SetController
} from "../generated/SmartExposureKeeperSubsidyPool/SmartExposureKeeperSubsidyPool"
...
export function handleSetBeneficiary(event: SetBeneficiary): void {
  ...
  entity.canRequest = event.params.canRequest
  ...
  // - contract.isBeneficiary(...)
  // - contract.requestSubsidy(...)
  // - contract.setBeneficiary(...)
