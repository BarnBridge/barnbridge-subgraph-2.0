...
export class crUSDTRewardsPool extends ethereum.SmartContract {
  static bind(address: Address): crUSDTRewardsPool {
    return new crUSDTRewardsPool("crUSDTRewardsPool", address);
  }
