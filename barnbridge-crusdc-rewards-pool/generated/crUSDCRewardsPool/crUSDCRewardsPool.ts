...
export class crUSDCRewardsPool extends ethereum.SmartContract {
  static bind(address: Address): crUSDCRewardsPool {
    return new crUSDCRewardsPool("crUSDCRewardsPool", address);
  }
